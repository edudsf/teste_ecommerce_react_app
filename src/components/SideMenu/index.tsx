  ...
  return (
    <Container>
      ...
      <Row2>
        <H2>COMPRAS</H2>
        <ul>
          <li><a href=""/><span>i</span><span>Promoções</span></li>
          <li><a href=""/><span>i</span><span>Produtos</span></li>
          <li><a href=""/><span>i</span><span>Pedidos</span></li>
          <li><a href=""/><span>i</span><span>Cupons</span></li>
        </ul>
      </Row2>
      <Row3>
